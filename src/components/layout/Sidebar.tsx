...
import {
  ...
  AlertTriangle, GitBranch, Settings, LogOut, Sun, Moon, FileBarChart, Shield, Stethoscope, Package, Receipt,
} from 'lucide-react'
...
const navItems: NavItem[] = [
  ...
  { href: '/contas-a-receber', label: 'Contas a Receber', icon: Receipt, requiresManualErp: true },
